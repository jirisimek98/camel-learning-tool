...
import { Extensions, IViewsService, IViewDescriptorService } from '../vscode/src/vs/workbench/common/views.js';
export { ViewContainerLocation } from '../vscode/src/vs/workbench/common/views.js';
import { ViewsService } from '../vscode/src/vs/workbench/browser/parts/views/viewsService.js';
...
import { IBreadcrumbsService, BreadcrumbsService } from '../vscode/src/vs/workbench/browser/parts/editor/breadcrumbs.js';
...
import { ITextEditorService, TextEditorService } from '../vscode/src/vs/workbench/services/textfile/common/textEditorService.js';
import { CodeEditorService } from '../vscode/src/vs/workbench/services/editor/browser/codeEditorService.js';
import { IUntitledTextEditorService, UntitledTextEditorService } from '../vscode/src/vs/workbench/services/untitled/common/untitledTextEditorService.js';
...
import { IWebviewWorkbenchService, WebviewEditorService } from '../vscode/src/vs/workbench/contrib/webviewPanel/browser/webviewWorkbenchService.js';
import { IWebviewService } from '../vscode/src/vs/workbench/contrib/webview/browser/webview.js';
import { IWebviewViewService, WebviewViewService } from '../vscode/src/vs/workbench/contrib/webviewView/browser/webviewViewService.js';
import { ILifecycleService } from '../vscode/src/vs/workbench/services/lifecycle/common/lifecycle.js';
import { IWorkbenchLayoutService, positionToString } from '../vscode/src/vs/workbench/services/layout/browser/layoutService.js';
...
import getServiceOverride$4 from './keybindings.js';
...
registerServiceInitializePostParticipant(async (accessor) => {
    ...
    for (const { id, role, classes, options, enabled = true } of [
        { id: "workbench.parts.titlebar" , role: 'none', classes: ['titlebar'], enabled: withTitlePart },
