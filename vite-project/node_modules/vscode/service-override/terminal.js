...
import { TerminalExtensions, ITerminalLogService } from '../vscode/src/vs/platform/terminal/common/terminal.js';
...
import { TerminalService } from '../vscode/src/vs/workbench/contrib/terminal/browser/terminalService.js';
import { TerminalEditorService } from '../vscode/src/vs/workbench/contrib/terminal/browser/terminalEditorService.js';
import { TerminalGroupService } from '../vscode/src/vs/workbench/contrib/terminal/browser/terminalGroupService.js';
import { TerminalInstanceService } from '../vscode/src/vs/workbench/contrib/terminal/browser/terminalInstanceService.js';
import { TerminalProfileService } from '../vscode/src/vs/workbench/contrib/terminal/browser/terminalProfileService.js';
import { ITerminalContributionService, TerminalContributionService } from '../vscode/src/vs/workbench/contrib/terminal/common/terminalExtensionPoints.js';
import { ITerminalLinkProviderService } from '../vscode/src/vs/workbench/contrib/terminalContrib/links/browser/links.js';
import { TerminalLinkProviderService } from '../vscode/src/vs/workbench/contrib/terminalContrib/links/browser/terminalLinkProviderService.js';
import { ElectronTerminalProfileResolverService } from '../vscode/src/vs/workbench/contrib/terminal/electron-sandbox/terminalProfileResolverService.js';
import { EnvironmentVariableService } from '../vscode/src/vs/workbench/contrib/terminal/common/environmentVariableService.js';
...
import { TerminalLogService } from '../vscode/src/vs/platform/terminal/common/terminalLogService.js';
import { TerminalQuickFixService } from '../vscode/src/vs/workbench/contrib/terminalContrib/quickFix/browser/terminalQuickFixService.js';
...
import '../vscode/src/vs/workbench/contrib/terminal/browser/terminal.contribution.js';
import '../vscode/src/vs/workbench/contrib/terminalContrib/accessibility/browser/terminal.accessibility.contribution.js';
