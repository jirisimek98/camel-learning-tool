...
import { IEditorCloseHandler, EditorInput } from '../vscode/src/vs/workbench/common/editor/editorInput.js';
...
import { ViewContainerLocation } from '../vscode/src/vs/workbench/common/views.js';
...
export { type CustomViewOption, type EditorPanelOption, IEditorCloseHandler, OpenEditor, Parts, ViewContainerLocation, attachPart, getServiceOverride as default, isEditorPartVisible, isPartVisibile, onPartVisibilityChange, registerCustomView, registerEditorPane, renderActivitybarPar, renderAuxiliaryPart, renderEditorPart, renderPanelPart, renderPart, renderSidebarPart, renderStatusBarPart, setPartVisibility };
