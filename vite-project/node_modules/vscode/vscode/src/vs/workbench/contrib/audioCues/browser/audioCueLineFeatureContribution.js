...
import { observableFromEvent, derived, autorun, debouncedObservable, wasEventTriggeredRecently, autorunDelta, constObservable, observableFromPromise, derivedOpts } from 'monaco-editor/esm/vs/base/common/observable.js';
...
let AudioCueLineFeatureContribution = class AudioCueLineFeatureContribution extends Disposable {
    constructor(editorService, instantiationService, audioCueService, _configurationService) {
        ...
        const someAudioCueFeatureIsEnabled = derived((reader) => (  this.features.some((feature) => this.isEnabledCache.get(feature.audioCue).read(reader))));
    ...
    registerAudioCuesForEditor(editor, editorModel, store) {
        ...
        const featureStates = ( this.features.map((feature) => {
            ...
            const isFeaturePresent = derivedOpts({ debugName: `isPresentInLine:${feature.audioCue.name}` }, (reader) => {
