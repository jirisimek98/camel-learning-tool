...
import { Emitter, Event, DynamicListEventMultiplexer } from 'monaco-editor/esm/vs/base/common/event.js';
...
import { DeatachedTerminal } from './detachedTerminal.js';
...
let TerminalService = class TerminalService extends Disposable {
    ...
    constructor(_contextKeyService, _lifecycleService, _logService, _dialogService, _instantiationService, _remoteAgentService, _viewsService, _configurationService, _environmentService, _terminalEditorService, _terminalGroupService, _terminalInstanceService, _editorGroupsService, _terminalProfileService, _extensionService, _notificationService, _workspaceContextService, _commandService, _keybindingService, _timerService) {
        ...
        this._onDidReceiveProcessId = this._register(( new Emitter()));
        ...
        this._onDidMaxiumumDimensionsChange = this._register(( new Emitter()));
        this._onDidChangeInstanceCapability = this._register(( new Emitter()));
        this._onDidChangeInstances = this._register(( new Emitter()));
        this._onDidChangeInstanceTitle = this._register(( new Emitter()));
        this._onDidChangeInstanceIcon = this._register(( new Emitter()));
        this._onDidChangeInstanceColor = this._register(( new Emitter()));
        this._onDidChangeActiveInstance = this._register(( new Emitter()));
        this._onDidChangeInstancePrimaryStatus = this._register(( new Emitter()));
        this._onDidInputInstanceData = this._register(( new Emitter()));
    ...
    async createDetachedTerminal(options) {
        ...
        const xterm = this._instantiationService.createInstance(XtermTerminal, ctor, this._configHelper, options.cols, options.rows, options.colorProvider, options.capabilities || ( new TerminalCapabilityStore()), '', undefined, false);
        if (options.readonly) {
