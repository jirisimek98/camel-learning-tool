...
let ReloadAction = class ReloadAction extends ExtensionAction {
    ...
    constructor(hostService, extensionService) {
        super('extensions.reload', ( (localize('reloadAction', "Reload"))), ReloadAction_1.DisabledClass, false);
...
export { AbstractConfigureRecommendedExtensionsAction, ClearLanguageAction, DisableForWorkspaceAction, DisableGloballyAction, DropDownMenuActionViewItem, EnableForWorkspaceAction, EnableGloballyAction, ExtensionAction, ExtensionDropDownAction, ExtensionStatusAction, ExtensionStatusLabelAction, IgnoreExtensionRecommendationAction, InstallAction, InstallAnotherVersionAction, InstallInOtherServerAction, InstallRecommendedExtensionAction, InstallSpecificVersionOfExtensionAction, InstallingLabelAction, ManageExtensionAction, MenuItemExtensionAction, MigrateDeprecatedExtensionAction, PromptExtensionInstallFailureAction, ReinstallAction, ReloadAction, SearchExtensionsAction, SetColorThemeAction, SetFileIconThemeAction, SetLanguageAction, SetProductIconThemeAction, ShowRecommendedExtensionAction, SwitchToPreReleaseVersionAction, SwitchToReleasedVersionAction, ToggleSyncExtensionAction, UndoIgnoreExtensionRecommendationAction, UninstallAction, UpdateAction };
