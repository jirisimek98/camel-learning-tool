...
import { TerminalExtensions, ITerminalLogService } from '../../../../platform/terminal/common/terminal.js';
...
let RemoteTerminalBackend = class RemoteTerminalBackend extends BaseTerminalBackend {
    ...
    async createProcess(shellLaunchConfig, cwd,
    cols, rows, unicodeVersion, env,
