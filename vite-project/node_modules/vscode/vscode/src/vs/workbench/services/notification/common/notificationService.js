...
let NotificationService = class NotificationService extends Disposable {
    ...
    constructor(storageService) {
        ...
        this._doNotDisturbMode = this.storageService.getBoolean(NotificationService_1.DND_SETTINGS_KEY, -1 , false);
    ...
    set doNotDisturbMode(enabled) {
        ...
        this.storageService.store(NotificationService_1.DND_SETTINGS_KEY, enabled, -1 , 1 );
