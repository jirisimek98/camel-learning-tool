...
import { Separator, IAction } from '../../../../base/common/actions.js';
import { Dimension } from '../../../../base/browser/dom.js';
import { IKeybindingService } from '../../../../platform/keybinding/common/keybinding.js';
import { IConfigurationService } from '../../../../platform/configuration/common/configuration.js';
import { Event } from '../../../../base/common/event.js';
import { Disposable, DisposableStore } from '../../../../base/common/lifecycle.js';
import { IWorkspacesService, IRecentlyOpened } from '../../../../platform/workspaces/common/workspaces.js';
...
type IOpenRecentAction = IAction & {
    uri: URI;
    remoteAuthority?: string;
};
declare abstract class MenubarControl extends Disposable {
...
declare class CustomMenubarControl extends MenubarControl {
    ...
    constructor(menuService: IMenuService, workspacesService: IWorkspacesService, contextKeyService: IContextKeyService, keybindingService: IKeybindingService, configurationService: IConfigurationService, labelService: ILabelService, updateService: IUpdateService, storageService: IStorageService, notificationService: INotificationService, preferencesService: IPreferencesService, environmentService: IWorkbenchEnvironmentService, accessibilityService: IAccessibilityService, layoutService: IWorkbenchLayoutService, telemetryService: ITelemetryService, hostService: IHostService, commandService: ICommandService);
...
export { CustomMenubarControl, type IOpenRecentAction, MenubarControl };
