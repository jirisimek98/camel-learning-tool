...
import { AccountsActivityActionViewItem, GlobalActivityActionViewItem, ViewContainerActivityAction, PlaceHolderViewContainerActivityAction, PlaceHolderToggleCompositePinnedAction, PlaceHolderToggleCompositeBadgeAction } from './activitybarActions.js';
...
let ActivitybarPart = class ActivitybarPart extends Part {
    ...
    registerListeners() {
        ...
        this._register(this.extensionService.onDidRegisterExtensions(() => {
            ...
            this.storageService.onDidChangeValue(0 , ActivitybarPart_1.PINNED_VIEW_CONTAINERS, disposables)(e => this.onDidPinnedViewContainersStorageValueChange(e), this, disposables);
            this.storageService.onDidChangeValue(0 , AccountsActivityActionViewItem.ACCOUNTS_VISIBILITY_PREFERENCE_KEY, disposables)(() => this.toggleAccountsActivity(), this, disposables);
        }));
    ...
    createGlobalActivityActionBar(container) {
        ...
        this.globalActivityAction = this._register(( new ActivityAction({
            ...
            classNames: ThemeIcon.asClassNameArray(ActivitybarPart_1.GEAR_ICON),
        })));
    ...
    getCompositeActions(compositeId) {
        ...
        if (!compositeActions) {
            ...
            if (viewContainer) {
                ...
                compositeActions = {
                    activityAction: this.instantiationService.createInstance(PlaceHolderViewContainerActivityAction, ActivitybarPart_1.toActivity(compositeId, compositeId, cachedComposite?.icon, undefined), this.paneCompositePart),
    ...
    layout(width, height) {
        ...
        if (this.globalActivityActionBar) {
            availableHeight -= (this.globalActivityActionBar.viewItems.length * ActivitybarPart_1.ACTION_HEIGHT);
        }
    ...
    getStoredPinnedViewContainersValue() {
        return this.storageService.get(ActivitybarPart_1.PINNED_VIEW_CONTAINERS, 0 , '[]');
    }
    setStoredPinnedViewContainersValue(value) {
        this.storageService.store(ActivitybarPart_1.PINNED_VIEW_CONTAINERS, value, 0 , 0 );
    }
    ...
    getStoredPlaceholderViewContainersValue() {
        return this.storageService.get(ActivitybarPart_1.PLACEHOLDER_VIEW_CONTAINERS, 0 , '[]');
    }
    setStoredPlaceholderViewContainersValue(value) {
        this.storageService.store(ActivitybarPart_1.PLACEHOLDER_VIEW_CONTAINERS, value, 0 , 1 );
    }
