...
let BasePanelPart = class BasePanelPart extends CompositePart {
    ...
    registerListeners() {
        ...
        this._register(this.extensionService.onDidRegisterExtensions(() => {
            ...
            this.storageService.onDidChangeValue(0 , this.pinnedPanelsKey, disposables)(() => this.onDidStorageValueChange(), this, disposables);
        }));
    }
    ...
    layoutCompositeBar() {
        if (this.contentDimension && this.dimension) {
            ...
            if (this.toolBar) {
                availableWidth = Math.max(BasePanelPart_1.MIN_COMPOSITE_BAR_WIDTH, availableWidth - this.getToolbarWidth());
            }
    ...
    onDidStorageValueChange() {
        if (this.cachedPanelsValue !== this.getStoredCachedPanelsValue() ) {
...
BasePanelPart = BasePanelPart_1 = ( __decorate([
