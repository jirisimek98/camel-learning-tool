...
function formatDocumentRangesWithProvider(accessor, provider, editorOrModel, rangeOrRanges, token) {
  ...
  return __awaiter7(this, void 0, void 0, function* () {
    ...
    const computeEdits = (range) => __awaiter7(this, void 0, void 0, function* () {
      var _c2, _d2;
...
var __awaiter7, FormattingConflicts;
...
init_languages();
init_languageConfigurationRegistry();
import "/home/jsimek/MUNI/diplomka/camel-learning-tool/vite-project/node_modules/monaco-editor/esm/vs/editor/contrib/folding/browser/folding.css";
...
init_network();
init_resources();
import "/home/jsimek/MUNI/diplomka/camel-learning-tool/vite-project/node_modules/monaco-editor/esm/vs/editor/contrib/gotoSymbol/browser/peek/referencesWidget.css";
init_range();
init_textModel();
init_languageConfigurationRegistry();
init_modesRegistry();
...
function getReferencesAtPosition(registry, model, position, compact, token) {
  return getLocationLinks(model, position, registry, (provider, model2, position2) => __awaiter5(this, void 0, void 0, function* () {
...
var SymbolNavigationAction = class _SymbolNavigationAction extends EditorAction2 {
  ...
  runEditorCommand(accessor, editor, arg, range) {
    ...
    const promise = raceCancellation(this._getLocationModel(languageFeaturesService, anchor.model, anchor.position, cts.token), cts.token).then((references) => __awaiter6(this, void 0, void 0, function* () {
      var _j;
...
CommandsRegistry.registerCommand({
  ...
  handler: (accessor, resource, position, references, multiple, noResultsMessage, openInPeek) => __awaiter6(void 0, void 0, void 0, function* () {
    assertType(URI.isUri(resource));
    assertType(Position.isIPosition(position));
...
CommandsRegistry.registerCommand({
  ...
  handler: (accessor, resource, position, references, multiple) => __awaiter6(void 0, void 0, void 0, function* () {
...
var InlayHintsFragments = class _InlayHintsFragments {
  static create(registry, model, ranges, token) {
    return __awaiter8(this, void 0, void 0, function* () {
      const data = [];
      const promises = registry.ordered(model).reverse().map((provider) => ranges.map((range) => __awaiter8(this, void 0, void 0, function* () {
        try {
...
init_position();
init_languages();
import "/home/jsimek/MUNI/diplomka/camel-learning-tool/vite-project/node_modules/monaco-editor/esm/vs/editor/contrib/inlineCompletions/browser/inlineCompletionsHintsWidget.css";
...
init_lifecycle();
init_strings();
import "/home/jsimek/MUNI/diplomka/camel-learning-tool/vite-project/node_modules/monaco-editor/esm/vs/editor/contrib/inlineCompletions/browser/ghostText.css";
init_editorOptions();
init_position();
init_range();
init_stringBuilder();
...
//# sourceMappingURL=chunk-B6SX2JWG.js.map
