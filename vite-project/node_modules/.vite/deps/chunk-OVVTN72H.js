...
var idPattern = "\\w+[-_\\w+]*";
var typeAndModifierIdPattern = `^${idPattern}$`;
var selectorPattern = `^(${idPattern}|\\*)(\\${CLASSIFIER_MODIFIER_SEPARATOR}${idPattern})*(${TOKEN_CLASSIFIER_LANGUAGE_SEPARATOR}${idPattern})?$`;
var fontStylePattern = "^(\\s*(italic|bold|underline|strikethrough))*\\s*$";
var TokenStyle = class {
...
var TokenClassificationRegistry = class {
  constructor() {
...
var tokenClassificationRegistry = createDefaultTokenClassificationRegistry();
function createDefaultTokenClassificationRegistry() {
  ...
  registerTokenType("label", localize("labels", "Style for labels. "), void 0);
  registry.registerTokenModifier("declaration", localize("declaration", "Style for all symbol declarations."), void 0);
  registry.registerTokenModifier("documentation", localize("documentation", "Style to use for references in documentation."), void 0);
  registry.registerTokenModifier("static", localize("static", "Style to use for symbols that are static."), void 0);
  registry.registerTokenModifier("abstract", localize("abstract", "Style to use for symbols that are abstract."), void 0);
  registry.registerTokenModifier("deprecated", localize("deprecated", "Style to use for symbols that are deprecated."), void 0);
  registry.registerTokenModifier("modification", localize("modification", "Style to use for write accesses."), void 0);
  registry.registerTokenModifier("async", localize("async", "Style to use for symbols that are async."), void 0);
  registry.registerTokenModifier("readonly", localize("readonly", "Style to use for symbols that are read-only."), void 0);
...
var tokenStylingSchemaId = "vscode://schemas/token-styling";
...
var delayer = new RunOnceScheduler(() => schemaRegistry.notifySchemaChanged(tokenStylingSchemaId), 200);
...
//# sourceMappingURL=chunk-OVVTN72H.js.map
