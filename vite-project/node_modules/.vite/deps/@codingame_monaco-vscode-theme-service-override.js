import {
  ...
  VS_LIGHT_THEME,
  themeScopeRegex
} from "./chunk-OI6YXRBQ.js";
import {
  getParseErrorMessage
} from "./chunk-N4LABOCD.js";
import {
  SemanticTokenRule,
  TokenStyle,
...
import "./chunk-4S2ZBTNY.js";
import {
  Color,
  ColorScheme,
  Extensions,
  Extensions2,
  Extensions4 as Extensions3,
  Extensions5 as Extensions4,
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/browser/workbenchThemeService.js
init_tslib_es6();
init_nls();
init_types();
init_telemetry();
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/colorThemeData.js
init_path();
init_color();

// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/themeCompatibility.js
init_color();
init_colorRegistry();
init_editorColorRegistry();
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/plistParser.js
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/textMateScopeMatcher.js
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/colorThemeData.js
init_theme();
var colorRegistry = Registry.as(Extensions4.ColorContribution);
...
var _ColorThemeData = class _ColorThemeData {
...
var ColorThemeData = _ColorThemeData;
...
function _loadSyntaxTokens(extensionResourceLoaderService, themeLocation, result) {
  return extensionResourceLoaderService.readExtensionResource(themeLocation).then((content) => {
    try {
      const contentValue = parse2(content);
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/fileIconThemeSchema.js
init_nls();
init_platform2();
init_jsonContributionRegistry();

// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/productIconThemeSchema.js
init_nls();
init_platform2();
init_jsonContributionRegistry();
var fontIdRegex = "^([\\w_-]+)$";
var fontStyleRegex = "^(normal|italic|(oblique[ \\w\\s-]+))$";
var fontWeightRegex = "^(normal|bold|lighter|bolder|(\\d{0-1000}))$";
var fontSizeRegex = "^([\\w .%_-]+)$";
var fontFormatRegex = "^woff|woff2|truetype|opentype|embedded-opentype|svg$";
var schemaId = "vscode://schemas/product-icon-theme";
var schema = {
  type: "object",
  allowComments: true,
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/fileIconThemeSchema.js
var schemaId2 = "vscode://schemas/icon-theme";
var schema2 = {
  type: "object",
  allowComments: true,
  allowTrailingCommas: true,
...
function registerFileIconThemeSchemas() {
  const schemaRegistry = Registry.as(Extensions.JSONContribution);
  schemaRegistry.registerSchema(schemaId2, schema2);
}

// node_modules/vscode/vscode/src/vs/workbench/services/themes/browser/workbenchThemeService.js
init_lifecycle();

// node_modules/vscode/vscode/src/vs/workbench/services/themes/browser/fileIconThemeData.js
init_nls();
init_path();
init_resources();
init_dom();
var _FileIconThemeData = class _FileIconThemeData {
  constructor(id, label, settingsId) {
    this.id = id;
    this.label = label;
    this.settingsId = settingsId;
...
var FileIconThemeData = _FileIconThemeData;
var FileIconThemeLoader = class {
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/colorThemeSchema.js
init_nls();
init_platform2();
init_jsonContributionRegistry();
init_colorRegistry();
...
var textmateColorsSchemaId = "vscode://schemas/textmate-colors";
var textmateColorGroupSchemaId = `${textmateColorsSchemaId}#/definitions/colorGroup`;
...
var colorThemeSchemaId = "vscode://schemas/color-theme";
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/themeExtensionPoints.js
init_nls();
init_types();
init_resources();
init_event();
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/common/themeConfiguration.js
init_nls();
init_types();
init_platform2();
init_configurationRegistry();
...
var colorThemeSettingEnum = [];
var colorThemeSettingEnumItemLabels = [];
var colorThemeSettingEnumDescriptions = [];
...
var preferredDarkThemeSettingSchema = {
  type: "string",
...
var preferredLightThemeSettingSchema = {
  type: "string",
  markdownDescription: localize(
...
var preferredHCDarkThemeSettingSchema = {
  type: "string",
  markdownDescription: localize(
...
var preferredHCLightThemeSettingSchema = {
  type: "string",
  markdownDescription: localize(
...
var detectColorSchemeSettingSchema = {
  type: "boolean",
  markdownDescription: localize(
...
var fileIconThemeSettingSchema = {
  type: ["string", "null"],
...
var productIconThemeSettingSchema = {
  type: ["string", "null"],
...
var detectHCSchemeSettingSchema = {
  type: "boolean",
  default: true,
  markdownDescription: localize(
...
var themeSettingsWindowConfiguration = {
  id: "window",
  order: 8.1,
  type: "object",
  properties: {
...
var semanticTokenColorCustomizationSchema = {
  description: localize(
    "semanticTokenColors",
...
// node_modules/vscode/vscode/src/vs/workbench/services/themes/browser/productIconThemeData.js
init_nls();
init_path();
init_resources();
init_types();
init_themables();
var DEFAULT_PRODUCT_ICON_THEME_ID = "";
var _ProductIconThemeData = class _ProductIconThemeData {
  constructor(id, label, settingsId) {
...
var ProductIconThemeData = _ProductIconThemeData;
...
init_colorRegistry();
init_language();
var PERSISTED_OS_COLOR_SCHEME = "osColorScheme";
var PERSISTED_OS_COLOR_SCHEME_SCOPE = -1;
var defaultThemeExtensionId = "vscode-theme-defaults";
var DEFAULT_FILE_ICON_THEME_ID = "vscode.vscode-theme-seti-vs-seti";
var fileIconsEnabledClass = "file-icons-enabled";
var colorThemeRulesClassName = "contributedColorTheme";
var fileIconThemeRulesClassName = "contributedFileIconTheme";
var productIconThemeRulesClassName = "contributedProductIconTheme";
var themingRegistry = Registry.as(Extensions3.ThemingContribution);
...
var colorThemesExtPoint = registerColorThemeExtensionPoint();
var fileIconThemesExtPoint = registerFileIconThemeExtensionPoint();
var productIconThemesExtPoint = registerProductIconThemeExtensionPoint();
var WorkbenchThemeService = class WorkbenchThemeService2 {
...
// node_modules/vscode/service-override/theme.js
init_themeService();
init_descriptors();
var StandaloneWorkbenchThemeService = class extends WorkbenchThemeService {
...
//# sourceMappingURL=@codingame_monaco-vscode-theme-service-override.js.map
